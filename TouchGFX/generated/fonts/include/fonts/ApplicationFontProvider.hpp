...
struct TypographyFontIndex
{
    ...
    static const touchgfx::FontId LARGE = 1;         // OCRAEXT_TTF_50_4bpp
    static const touchgfx::FontId SMALL = 2;         // verdana_15_4bpp
    static const touchgfx::FontId TYPOGRAPHY_00 = 3; // OCRAEXT_TTF_20_4bpp
    static const touchgfx::FontId TYPOGRAPHY_01 = 4; // arialbd_20_4bpp
